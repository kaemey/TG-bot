...
<h4>2.6 Создать базу данных с указанными выше данными, необходимые поля: <br> username(varchar(32)), <br> chat_id(int(20)), <br>
  статус оплаты для QIWI: buy(int(1)) <br> и admin(int(1)).
<h2>Пример</h3>
